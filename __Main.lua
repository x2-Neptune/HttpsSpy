...
local Serializer = loadstring(game:HttpGet("https://raw.githubusercontent.com/x2-Neptune/HttpsSpy/main/Loader/__Nexus.lua"))();
...
local RecentCommit = game.HttpService:JSONDecode(game:HttpGet("https://api.github.com/repos/x2-Neptune/HttpsSpy/commits?per_page=1&path=__Main.lua"))[1].commit.message;
...
if not debug.info(2, "f") then
    pconsole("You are running an outdated version");
end;
